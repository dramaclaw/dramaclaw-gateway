...
To report a security issue, use the GitHub Security Advisories tab to [open a draft security advisory](https://github.com/dramaclaw/dramaclaw-gateway/security/advisories/new). This is the preferred method because it provides a private communication channel.
