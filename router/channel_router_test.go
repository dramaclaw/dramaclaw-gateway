...
func TestChannelTypesRouteUsesReadPermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "/types", authz.ChannelRead, controller.GetChannelTypes)
}
